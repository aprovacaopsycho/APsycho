...
const bpath = 'c:/Users/NATHAN/OneDrive/ANTIGOS/Documentos/GitHub/APsycho/Base/bpa/';
const files = ['bpa_aa.html', 'bpa_ac.html', 'bpa_ad.html'];
...
files.forEach(f => {
    ...
    if (match) {
        ...
        // Let's generate the updated finish test block
                    ...
                    try {
                        ...
                        if (result.sucesso) {
                            ...
                            this.grid.forEach((item, index) => {
                                ...
                                // Update alpine properties for visual
                            });

                            this.state = 'results';
                            window.scrollTo(0, 0);

                            const meta = result.meta || 96;
                            ...
                            if (typeof this.saveHistory === 'function') {
                                ...
                                // fallback if saveHistory takes no arguments
                                this.saveHistory();
                            }
                        } else {
        ...
        if (splitStart.length === 2) {
            // we find the end of the finishTest function
            // look for showVisualReview() as the next function
